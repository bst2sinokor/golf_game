...
| 조폭 스킨스 | 스킨스 + 벌칙/강탈. ① 보기·더블·트리플 시 누적 보유금을 토해냄(설정금액 단위 올림, 강도 옵션: 더블50·트리플+100 전홀 / 파3만 한 단계 엄격) ② 반납금은 그 홀 승자 독식 ③ 버디 시 나머지 전원 보유금 강탈. **18홀 단독 진행(다른 메인 게임과 동시 선택 불가, 단 신페리오·니어·롱기는 병행 가능), 기본배분 적용·버디값 미적용**. 내부 키 jopok |
