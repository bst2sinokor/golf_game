...
const FLOW_STEPS: { t: string; d: string; chips?: string[]; tag?: string }[] = [
  ...
  {
    t: '홀 진행',
    d: '진행자가 [게임 시작]을 누르면 화면 우측 상단에 LIVE가 뜨면서 홀이 진행돼요. 더불어 첫 홀 티샷 순서를 자동으로 선정해줘요. 각자 자기 점수를 넣어요. 전원이 넣으면 그 홀 결과가 나오고, 진행자가 다음 홀로 넘겨요. OECD에 가입되면 페널티 입력창이 추가로 나와요 — 페널티 입력도 꼭 해주세요.',
